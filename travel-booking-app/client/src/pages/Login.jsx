      ...
      <div className="w-full max-w-sm animate-fade-in-up">
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-8 transition-colors duration-200">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">{t('auth.signIn')}</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{t('auth.welcomeBack')}</p>
          </div>

          {/* Success Message */}
          {successMsg && (
            <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-sm flex items-center gap-2 animate-fade-in-down">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1">{t('auth.emailAddress')}</label>
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1">{t('auth.password')}</label>
              <div className="relative">
            ...
            <div className="flex justify-end">
              <Link
                to="/forgot-password"
                className="text-xs font-medium text-primary-800 dark:text-primary-400 hover:text-primary-900 dark:hover:text-primary-300 transition-colors hover:underline"
              >
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white dark:bg-gray-800 px-2 text-gray-400 dark:text-gray-500 font-medium">{t('auth.newToTravelBook')}</span>
            </div>
          </div>
